...
class Response():
	...
	def __init__(self, content = "", status = "N/A", prompt = "", model = "", duration = 0.0, messages = [], variables = {}):
		self.content: str = content      				  # This is the content of the last message (the text completion)
		self.status: str = status        				  # This is the status of the response (e.g. "success", "error")
		...
		self.messages: list[dict[str, str]] = messages    # This is the message history; it's at least the last two messages (user and model)
