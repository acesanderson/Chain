...
class AnthropicClient(Client):
	...
	def query(self, model: str, input: 'str | list', pydantic_model: BaseModel = None) -> 'str | BaseModel':
		"""
		...
		if isinstance(input, str):
			...
			# We could be more rigorous here and define a Message object using pydantic. For now, we assume the input is a list of dictionaries.
			input = input
	...
	async def query_async(self, model: str, input: 'str | list', pydantic_model: 'BaseModel' = None) -> 'BaseModel | str':
